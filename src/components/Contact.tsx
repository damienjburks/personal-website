      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Get In <span className="text-yellow-600 dark:text-yellow-400">Touch</span>
          </h2>
          <p className="text-gray-600 dark:text-gray-400">Let's discuss your project</p>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Feel free to reach out to me any time. I prefer email communication, but I'm available through other channels as well.
              </p>
            </div>
