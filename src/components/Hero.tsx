...
const Hero: React.FC = () => {
  ...
  return (
    <section 
      ...
      style={{
        backgroundImage: 'url("https://images.pexels.com/photos/1181676/pexels-photo-1181676.jpeg")',
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className={`transition-opacity duration-1000 ${showContent ? 'opacity-100' : 'opacity-0'}`}>
            <p className="mt-6 text-gray-300 leading-relaxed max-w-2xl mx-auto">
              I'm passionate about cloud security, DevOps excellence, and empowering others through education. With expertise in AWS, security best practices, and automation, I help organizations build secure and scalable cloud solutions while sharing knowledge through content creation and community engagement.
            </p>
          </div>
        </div>
      </div>
