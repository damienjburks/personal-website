...
const Specialties: React.FC = () => {
  const specialties = [
    ...
    },
    {
      ...
      description:
        "I’ve contributed to projects like Common Cloud Controls (CCC) and Open Policy Agent (OPA), and now lead The DevSec Blueprint (DSB), an open-source platform advancing cloud-native security and DevSecOps education.",
    },
    {
